                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return ListTile(
                              ...
                              trailing: Chip(
                                label: Text(user.status.displayName),
                                backgroundColor: user.status.statusColor.withValues(alpha: 0.2),
                              ),
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text('状态: ${_currentUser!.status.displayName}'),
                                  Text('创建时间: ${_currentUser!.createdAt.toString().substring(0, 19)}'),
                                  if (_currentUser!.updatedAt != null)
                                    Text('更新时间: ${_currentUser!.updatedAt.toString().substring(0, 19)}'),
                                ],
                              ),
                            ),
                          ),
